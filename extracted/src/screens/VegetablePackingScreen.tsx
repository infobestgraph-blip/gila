...
export default function VegetablePackingScreen({ onNavigate }: VegetablePackingScreenProps) {
  ...
  const vegetableProductBoxes = [
    {
      title: "High-Pungency Garlic",
      subtitle: "Aerated Orange Crate",
      image: "https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?auto=format&fit=crop&q=80&w=400",
      desc: "Cured Gilan white garlic bulbs, dry-wind sorted in orange lightweight crates."
    },
    {
      title: "Crisp Iceberg Lettuce",
      subtitle: "Vacuum-Cooled White Crate",
      image: "https://images.unsplash.com/photo-1622484211148-716598e0911a?auto=format&fit=crop&q=80&w=400",
      desc: "Triple-walled waxed fiberboard cartons with ventilation windows for iceberg lettuce pre-cooling."
    },
    {
      title: "Bell Pepper Selects",
      subtitle: "Tough Triple-Wall Carton",
      image: "https://images.unsplash.com/photo-1563565312-9ab2e6a52651?auto=format&fit=crop&q=80&w=400",
      desc: "Shock-insulated segment boxes for shiny red & yellow bell peppers with structural rigidity."
    }
  ];
  ...
  const vegetableBrandedFrames = [
    {
      id: "frame-garlic",
      title: "5 KG COMPACT GARLIC CRATE",
      badge: "Allium",
      tag: "Cured",
    ...
    {
      id: "frame-parsley",
      title: "PARSLEY CARTON REFRIGERATED EXPORT",
      badge: "Allium",
      tag: "Fresh Cut",
    ...
    },
    {
      ...
      title: "SHIELD PROTECTIVE COLOURED PEPPERS",
      badge: "Allium",
      tag: "Optic Sorted",
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-900 selection:bg-emerald-800 selection:text-white" id="vegetable-packing-root">
      ...
      <div className="relative bg-[#01261d] text-white overflow-hidden pt-24 pb-20 sm:pt-[112px] sm:pb-28 md:pt-[148px] text-center" id="vegetable-packing-hero">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 flex flex-col items-center justify-center space-y-4">
          ...
          <div className="flex items-center gap-2 font-mono text-[10px] text-emerald-300 tracking-wider mb-2">
            ...
            <span>/</span>
            <span className="text-white uppercase font-black">Vegetable Packaging</span>
          </div>
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-black tracking-tight max-w-4xl leading-tight text-white drop-shadow-sm">
            Gilafruit: Present Your Vegetables to the World with Freshness and Quality
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16" id="intro-text-section">
        <div className="space-y-12">
          ...
          <div className="max-w-5xl mx-auto text-slate-700 text-xs sm:text-sm leading-relaxed text-justify space-y-4">
            <p>
              With a distinguished history in the vegetable export industry, 
              <strong> Gilafruit</strong> offers a comprehensive range of packaging solutions to maintain the freshness 
              and quality of vegetables during transportation and captivate international customers. 
              Utilizing our expertise and experience, we design and manufacture containers using high-quality materials and 
              specifically tailored to the needs of each type of vegetable.
            </p>
            <p>
              Our understanding of the crucial role of proper presentation in vegetable export 
              drives our commitment to providing solutions that help you preserve the freshness, vibrancy, and flavor of your 
              vegetables throughout their journey to global markets. By choosing Gilafruit, you can reap numerous benefits, including:
            </p>
            ...
            <div className="lg:col-span-4 bg-[#014134] text-white rounded-3xl p-8 sm:p-10 flex flex-col justify-between shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <h3 className="font-display font-black text-2xl sm:text-3xl leading-tight tracking-tight">
                  Sustainable Packaging for Iran's Sustainable Vegetables
                </h3>
