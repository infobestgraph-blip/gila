...
export default function FAQPaymentScreen() {
  ...
  const paymentQuestions: FAQItem[] = [
    {
      ...
      answer: 'In the "Contact Us" section of the GilaFruit website, you\'ll find details to get in touch, including phone numbers, email, and addresses, plus a contact form. For quicker communication regarding the ordering process, connect with our sales team via WhatsApp and other messaging apps. They can guide you through the ordering process efficiently.',
      tags: ['place order', 'how to order', 'contact', 'sales process', 'whatsapp']
    },
    {
      question: 'What payment methods do you accept?',
      answer: 'GilaFruit provides secure international payment solutions for wholesale fruit and vegetable shipments:\n\n• Telegraphic Transfer (T/T): Direct wire transfers to our partner corporate bank accounts located in United Arab Emirates (AED), Oman (OMR), Turkey (USD/EUR), or Russian Federation (RUB).\n\n• Letter of Credit (L/C): Confirmed, irrevocable at-sight letters of credit are fully accepted under pre-approved international banking guarantees.\n\n• Multicurrency Cash Settlements: Permitted at designated trade offices to expedite emergency logistics clearances.',
      tags: ['payment methods', 'wire transfer', 'tt', 'letter of credit', 'lc', 'currencies']
    },
    {
      question: 'Is it possible to purchase a sample?',
      answer: 'Yes! We encourage new global partners to audit our quality first hand:\n\n• Sample Produce: Pre-selected export-grade Hayward Kiwis, oranges, lemons, or let-tuce samples are provided completely free of charge.\n\n• Logistic Expenses: The express temperature-controlled air packaging and international courier/freight charges are paid or reimbursed by the buyer prior to shipping.',
      tags: ['sample cargo', 'quality test', 'trial harvest', 'shipping fee']
    },
    {
      question: 'Are there discounts for bulk orders?',
      answer: 'Yes, GilaFruit offers flexible seasonal price schemes to recognize and reward volume loyalty:\n\n• Container Scale Discounts: Graduated rate drops per metric ton when signing multiple refrigerated reefer container batches (e.g. 5+ containers under one contract).\n\n• Seasonal Price Protection: Long-term distribution agreements provide absolute safeguards, locking your high-grade citrus or kiwi rates from sudden peak harvest pricing surges.',
      tags: ['discounts', 'wholesale rates', 'container price', 'seasonal limits', 'contracts']
    },
    {
      question: 'How can I track my order status?',
      answer: 'We ensure a highly secure, modern, and transparent export logistics cycle:\n\n• Dedicated Cargo Manager: A specific trade associate acts as your single point of logistics monitoring.\n\n• Daily Progress Delivery: Our team forwards real-time GPS coordinates of marine vessels or refrigerated trucks, along with immediate cold-storage temperature log charts and draft customs declaration documents to avoid clearance delays.',
      tags: ['tracking cargo', 'reefer temperature', 'logistics support', 'customs status', 'shipment']
    },
    {
      question: 'In which languages can customers communicate?',
      answer: 'To ensure effortless worldwide commercial operations and pristine legal matching, our trade support desk works fluently in multiple major languages:\n\n• Supported Languages: English, Persian (Farsi), Russian, Arabic, and Turkish.\n\n• Polyglot Documentation: We print custom carton labels, phytosanitary declarations, invoices, and certificates of origin in your native language blocks to satisfy local retail rules.',
      tags: ['languages', 'support desk', 'russian', 'english', 'arabic', 'persian', 'polyglot']
    }
  ];

  const filteredQuestions = paymentQuestions.filter(q => 
  ...
  return (
    <div className={`bg-[#fbfcfa] min-h-screen text-slate-800 relative font-sans transition-all duration-300 overflow-hidden pt-24 sm:pt-28 md:pt-[135px] pb-24 ${isRtl ? 'text-right' : 'text-left'}`} dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex items-center justify-between gap-4 text-xs text-slate-500 font-semibold mb-8 border-b border-slate-100 pb-3" id="faq-pay-breadcrumbs">
          <div className="flex items-center gap-2">
            ...
            <ChevronRightIcon className={`w-3.5 h-3.5 text-slate-400 ${isRtl ? 'rotate-180' : ''}`} />
            <span className="text-emerald-950 font-bold">Ordering and Payment</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-16">
          <div className="lg:col-span-12 space-y-5">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1 bg-[#1a8a42]/10 border border-[#1a8a42]/20 text-[#1a8a42] rounded-full text-xs font-bold uppercase tracking-wider font-mono">
              <CreditCard className="w-4 h-4 text-[#1a8a42] shrink-0" />
              <span>International Wholesale Terms</span>
            </div>
            
            <h1 className="font-display text-4xl sm:text-5xl font-black text-[#01261d] tracking-tight leading-tight">
              Do you have any questions about the <span className="text-[#1a8a42]">Ordering and Payment process?</span>
            </h1>
            
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-full">
              Need help with your order? Our comprehensive guides on Ordering and Payment have you covered every step of the way. From understanding our seamless Ordering process to exploring a variety of convenient Payment methods, we've made it easy to shop with us. Discover our exclusive Discount programs designed to save you money. Can't find what you're looking for? Our dedicated customer support team is here to assist you. Sorting is a critical step in the fruit and vegetable supply chain, ensuring that only the highest Product Quality produce reaches customers. Proper Fruit and Vegetable Packaging is also essential for maintaining Product Quality during Export Logistics. Understanding the nuances of Fruit and Vegetable Sorting and efficient Export Logistics are key to successful produce distribution.
            </p>

            {/* Keyword Fast Filter Tags */}
            <div className="flex flex-wrap gap-2 pt-1 font-mono">
              <span className="text-[10px] bg-emerald-50 text-[#1a8a42] border border-emerald-100 px-3 py-1 rounded-full font-bold">#OrderingProcess</span>
              <span className="text-[10px] bg-emerald-50 text-[#1a8a42] border border-emerald-100 px-3 py-1 rounded-full font-bold">#PaymentCurrencies</span>
              <span className="text-[10px] bg-emerald-50 text-[#1a8a42] border border-emerald-100 px-3 py-1 rounded-full font-bold">#TrialSamples</span>
              <span className="text-[10px] bg-emerald-50 text-[#1a8a42] border border-emerald-100 px-3 py-1 rounded-full font-bold">#VolumeDiscounts</span>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-[24px] border border-slate-200/90 shadow-sm overflow-hidden group">
              <div className="relative h-56 overflow-hidden">
                <img 
                  ...
                  alt="GilaFruit Effortless Bulk Orders Meeting"
              ...
              <div className="p-5 space-y-3.5">
                ...
                <p className="text-[11px] text-slate-500 leading-relaxed font-sans">
                  Our credit analysts and regional trade desk advisors are available round-the-clock to coordinate telegraphic transfers, prepare custom proforma invoicing, and verify payment routing records.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-slate-150 pb-4 gap-4">
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  placeholder="Filter order & payment..."
            ...
            <div className="space-y-4">
              {filteredQuestions.length === 0 ? (
                <div className="bg-white rounded-2xl border border-dashed border-slate-200 p-12 text-center space-y-3">
                  ...
                  <h4 className="font-bold text-slate-800">No matching search ordering & payment details</h4>
                  <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
                    We could not locate matching items for &ldquo;{searchQuery}&rdquo;. Try typing terms like &ldquo;order&rdquo;, &ldquo;payment&rdquo;, or &ldquo;discount&rdquo;.
                  </p>
                  <button
                    type="button"
                            ...
                            <div className="px-6 pb-6 pt-2 border-t border-slate-100 bg-slate-50/20">
                              ...
                              <div className="mt-5 pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between text-[11px] sm:pl-12 text-slate-400 font-semibold gap-3">
                                <span className="flex items-center gap-1.5">
                                  ...
                                  <span>Official GilaFruit Ordering & Payment Standards</span>
                                </span>
                                <button
                                  type="button"
