...
export default function FreightRatesServiceScreen({ onNavigate }: FreightRatesServiceScreenProps) {
  ...
  // Exact 17 Cards matching the provided screenshot
  ...
  return (
    <div className="bg-[#fcfdfc] min-h-screen text-slate-800 pb-20 animate-fade-in" id="freight-rates-page">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-4">
          <h1 className="font-display text-2xl sm:text-3xl lg:text-5xl font-black text-white tracking-tight leading-tight max-w-4xl mx-auto">
            Daily Update of Ground Transportation Rates from Astara Iran Terminal
          </h1>
          <p className="text-xs sm:text-sm md:text-base text-emerald-100/90 leading-relaxed max-w-3xl mx-auto font-medium">
            Our Freight Rate List offers simple pricing for global shipping of agricultural products from the Astara terminal. Check our Freight Rate List for transparent pricing considering exchange rates.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 space-y-4">
              <p className="text-xs sm:text-[13.5px] text-slate-500 leading-relaxed font-medium">
                GilaFruit is committed to making things easier for importers and traders. That's why we provide daily updates on ground transportation rates from the Astara terminal to various countries. Due to fluctuations in exchange rates, truck demand, and other factors, these rates may change daily.
              </p>
              <p className="text-xs sm:text-[13.5px] text-slate-500 leading-relaxed font-medium">
                To get the most accurate and up-to-date pricing and shipping terms for your agricultural products, please check our Shipping Rate Table regularly or contact our sales team. Please note that the rates provided on this page are estimates and intended for initial cost calculations. For precise calculations of total costs, we recommend consulting with our sales team.
              </p>
            </div>

            {/* Cartoon Shipping Truck Illustration exactly matching image layout */}
            <div className="lg:col-span-4 flex justify-center py-4 bg-slate-50/50 rounded-3xl">
              <svg viewBox="0 0 350 250" className="w-full max-w-[210px] h-auto drop-shadow-sm" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Background round cloud graphic */}
                ...
                {/* Green leaves / trees decorative background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 text-left">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#f4fbf7]/40 border border-emerald-100 p-4 rounded-3xl">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto md:justify-end">
            ...
            {/* Land Segment Selector with original icon overlay */}
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        {activeSegment !== 'land' ? (
          /* Empty or Coming Soon State for non-land transports, matching enterprise structure */
          <div className="py-20 text-center bg-white rounded-3xl border border-slate-100 shadow-sm max-w-xl mx-auto space-y-4">
            ...
            <div className="space-y-1">
              <h3 className="font-display font-black text-slate-800 text-base">
                {activeSegment === 'sea' ? 'Maritime Cargo Lines' : 'EAEU Air Freight Schedules'}
              </h3>
            ...
            <button
              ...
              className="px-5 py-2.5 bg-emerald-850 text-white font-bold text-xs uppercase tracking-wider rounded-xl hover:bg-emerald-900 transition-all cursor-pointer"
            >
              Consult Brokerage Gate →
            </button>
          </div>
          ...
          <div className="py-20 text-center bg-slate-50/50 rounded-3xl border border-slate-100 max-w-md mx-auto space-y-2">
            ...
            <p className="text-xs text-slate-400 max-w-xs mx-auto">
              No daily transport lines matched "{searchQuery}" departing Astara terminal. Check country spellings or search "Russia".
            </p>
          </div>
        ) : (
          /* Grid segment presenting exactly structured cards */
              ...
              >
                ...
                <div className="flex justify-between items-end gap-2 text-left">
                  <div className="space-y-3 min-w-0">
                    ...
                    {/* Datetime indicator with pulsing online marker */}
                  ...
                  {/* Core spot index quotation in emerald green */}
        ...
        <div className="bg-[#f0fbf7] rounded-3xl p-6 sm:p-8 border border-emerald-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-2 max-w-3xl">
            <h4 className="font-display font-black text-slate-900 text-sm sm:text-base flex items-center gap-2">
              ...
              Need Contractual Rate Bindings for the Harvest Season?
            </h4>
          ...
          <button
            onClick={() => onNavigate?.('#/contact')}
            className="px-6 py-3 bg-[#eab308] hover:bg-amber-600 active:scale-95 text-slate-950 font-black text-xs uppercase tracking-wider rounded-xl shadow-md transition-all shrink-0 cursor-pointer"
          >
            Inquire Rate Contracts
          </button>
        </div>
      </div>
