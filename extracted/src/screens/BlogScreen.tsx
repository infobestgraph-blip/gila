...
export const BLOG_LOCALES: Record<string, {
  blog: string;
  home: string;
  ...
  astara: string;
  bilehsavar: string;
  priceInquiryTitle: string;
  priceInquiryDesc: string;
  callForPrice: string;
  inWhatsApp: string;
  shippingInquiryTitle: string;
  shippingInquiryDesc: string;
  sampleTitle: string;
  sampleDesc: string;
  request: string;
  readMore: string;
  ...
  en: {
    ...
    searchBtn: "Search",
    situation: "SITUATION",
    fruitsVegs: "Iranian Fruits and Vegetables",
    available: "Available",
    limited: "Limited",
    unavailable: "Unavailable",
    viewDetails: "View Details →",
    allData: "All Data",
    customsStats: "CUSTOMS STATISTICS",
    livePortStream: "Live Border Statistics",
    terminals: "Terminals",
    products: "Products",
    quantity: "Quantity",
    loading: "Loading data...",
    allCustoms: "All Customs",
    astara: "Astara/Astara",
    bilehsavar: "Bilehsavar",
    priceInquiryTitle: "Product Price Inquiry",
    priceInquiryDesc: "Esteemed Traders, Our team at Gilafruit is eager to assist you in obtaining the most up-to-date pricing for Iranian fresh fruits and vegetables.",
    callForPrice: "Call for Price",
    inWhatsApp: "In WhatsApp",
    shippingInquiryTitle: "Shipping Price Inquiry",
    shippingInquiryDesc: "Experience global fruit and vegetable trade easier than ever with Gilafruit! Get instant online quotes for shipping your produce from Iran to anywhere in the world.",
    sampleTitle: "Send Product Samples",
    sampleDesc: "At Gilafruit, we are confident in the quality of our products and we arrange to provide experience that confidence too. That's why we offer free product samples to our customers before they buy.",
    request: "Request",
    readMore: "Read More",
    noResults: "No blog articles match search keywords",
    noResultsSub: "Try searching for other fruits or products like \"Kiwi\" or \"Garlic\".",
    productsNames: {
      "Kiwi": "Kiwi",
  ...
  fa: {
    ...
    searchBtn: "جستجو",
    situation: "وضعیت موجودی مرز",
    fruitsVegs: "میوه و تره‌بار صادراتی ایران",
    available: "موجود",
    limited: "محدود",
    unavailable: "ناموجود",
    viewDetails: "مشاهده جزئیات ←",
    allData: "مشاهده همه",
    customsStats: "آمار گمرک و ترانزیت",
    livePortStream: "جریان زنده گمرکات مرزی",
    terminals: "پایانه‌ها",
    products: "محصولات",
    quantity: "حجم (تن)",
    loading: "در حال بارگذاری...",
    allCustoms: "کل گمرکات",
    astara: "آستارا",
    bilehsavar: "بیله‌سوار",
    priceInquiryTitle: "استعلام قیمت روز محصولات",
    priceInquiryDesc: "بازرگانان گرامی، تیم پشتیبانی گیلافرود آماده ارائه جدیدترین قیمت‌های صادراتی میوه و تره‌بار ایران به شما عزیزان می‌باشد.",
    callForPrice: "تماس برای قیمت",
    inWhatsApp: "در واتس‌اپ",
    shippingInquiryTitle: "استعلام هزینه حمل و لجستیک",
    shippingInquiryDesc: "تجارت بین‌المللی آسان با گیلافرود! استعلام هزینه ترانزیت کانتینرهای یخچالی از ایران به سراسر دنیا به صورت آنلاین.",
    sampleTitle: "درخواست ارسال نمونه محصول",
    sampleDesc: "ما در گیلافرود به کیفیت محصولات خود اطمینان داریم. به منظور کسب اطمینان بیشتر، پیش از خرید عمده امکان ارسال رایگان نمونه محصول را فراهم ساخته‌ایم.",
    request: "ثبت درخواست",
    readMore: "ادامه مطلب",
    noResults: "هیچ مقاله‌ای با این کلمات کلیدی یافت نشد",
    noResultsSub: "جستجوی کلمات دیگر مانند «کیوی» یا «سیر» را امتحان کنید.",
    productsNames: {
      "Kiwi": "کیوی صادراتی",
      "Iceberg Lettuce": "کاهو آیسبرگ",
      "Bell Pepper": "فلفل دلمه‌ای",
      "Romaine Lettuce": "کاهو رسمی",
      "Celery": "کرفس صادراتی",
      "Broccoli": "کلم بروکلی",
      "Watermelon": "هندوانه سرخ",
      "Tomato": "گوجه‌فرنگی",
      "Sweet Corn": "ذرت شیرین",
      "Fresh Garlic": "سیر تازه",
      "Cherry": "گیلاس",
      "Eggplant": "بادمجان",
      "Potato": "سیب‌زمینی",
      "Cabbage": "کلم برگ",
      "Cucumber": "خیار رسمی",
      "Cauliflower": "گل کلم",
      "Seedless Grapes": "انگور بی‌دانه",
      "Sweet Cherry": "گیلاس شیرین",
      "Yellow Onions": "پیاز زرد"
    },
    months: {
      "Jan - Dec": "دی - آذر",
      "Feb - Jul": "بهمن - تیر",
  ...
  ru: {
    ...
    searchBtn: "Найти",
    situation: "СТАТУС ПОСТАВОК",
    fruitsVegs: "Иранские фрукты и овощи",
    available: "Доступно",
    limited: "Ограничено",
    unavailable: "Нет в наличии",
    viewDetails: "Подробнее →",
    allData: "Все данные",
    customsStats: "ТАМОЖЕННАЯ СТАТИСТИКА",
    livePortStream: "Таможенный поток в реальном времени",
    terminals: "Терминалы",
    products: "Продукты",
    quantity: "Объем (т)",
    loading: "Загрузка данных...",
    allCustoms: "Все порты",
    astara: "Астара",
    bilehsavar: "Билясувар",
    priceInquiryTitle: "Запрос цены на продукцию",
    priceInquiryDesc: "Уважаемые трейдеры, наша команда GilaFruit готова помочь вам оперативно получить самые актуальные оптовые цены на иранские овощи и фрукты.",
    callForPrice: "Позвонить",
    inWhatsApp: "В WhatsApp",
    shippingInquiryTitle: "Расчет стоимости доставки",
    shippingInquiryDesc: "Сделайте торговлю овощами и фруктами проще вместе с GilaFruit! Мгновенный расчет стоимости фрахта рефрижераторов из Ирана в любую точку мира.",
    sampleTitle: "Отправка образцов продукции",
    sampleDesc: "Мы абсолютно уверены в качестве нашей продукции и хотим, чтобы вы тоже убедились в этом. Бесплатно предоставим образцы товаров перед оформлением заказа.",
    request: "Запрос",
    readMore: "Читать далее",
    noResults: "Нет статей, соответствующих ключевым словам",
    noResultsSub: "Попробуйте поискать другие фрукты или продукты, например, «Киви» или «Чеснок».",
    productsNames: {
      "Kiwi": "Киви Хейворд",
      ...
      "Seedless Grapes": "Виноград кишмиш",
      "Sweet Cherry": "Сладкая черешня",
      "Yellow Onions": "Желтый лук"
    },
    months: {
      "Jan - Dec": "Январь - Декабрь",
      "Feb - Jul": "Февраль - Июль",
      "Apr - Jul": "Апрель - Июль",
      "Feb - Aug": "Февраль - Август",
      "Jul - Nov": "Июль - Ноябрь",
      "Jun - Aug": "Июнь - Август",
      "Nov - Jan": "Ноябрь - Январь"
    }
  },
  ar: {
    blog: "المدونة",
    ...
    searchBtn: "بحث",
    situation: "حالة التوفر",
    fruitsVegs: "الخضار والفواكه الإيرانية",
    available: "متوفر",
    limited: "محدود",
    unavailable: "غير متوفر",
    viewDetails: "عرض التفاصيل ←",
    allData: "جميع البيانات",
    customsStats: "إحصاءات الجمارك",
    livePortStream: "حركة المنافذ المباشرة",
    terminals: "المحطات",
    products: "المنتجات",
    quantity: "الكمية (طن)",
    loading: "جاري التحميل...",
    allCustoms: "جميع جمارك",
    astara: "آستارا",
    bilehsavar: "بيلسوار",
    priceInquiryTitle: "الاستعلام عن أسعار المنتجات",
    priceInquiryDesc: "يسعد فريق جيلافرود تقديم المساعدة لكم للحصول على أحدث الأسعار للخضروات والفواكه الإيرانية الطازجة.",
    callForPrice: "اتصل للسعر",
    inWhatsApp: "في واتساب",
    shippingInquiryTitle: "الاستعلام عن تكلفة الشحن",
    shippingInquiryDesc: "نسهل لكم تجارة الخضروات والفواكه! احصل على عروض أسعار فورية لشحن حاويات التبريد من إيران إلى العالم.",
    sampleTitle: "طلب عينات من المنتجات",
    sampleDesc: "نحن في جيلافرود نثق بجودة منتجاتنا، لذا نقدم عينات مجانية لعملائنا لمعرفة الجودة قبل الشراء.",
    request: "تقديم طلب",
    readMore: "اقرأ المزيد",
    noResults: "لم يتم العثور على مقالات تطابق الكلمة المفتاحية",
    noResultsSub: "حاول البحث عن منتجات أخرى مثل \"الكيوي\" أو \"الثوم\".",
    productsNames: {
      "Kiwi": "الكيوي",
      "Iceberg Lettuce": "خس آيسبرغ",
      "Bell Pepper": "الفلفل الحلو",
      "Romaine Lettuce": "الخس الروماني",
      "Celery": "الكرفس",
      "Broccoli": "البروكلي",
      "Watermelon": "البطهيخ",
      "Tomato": "الطماطم",
      "Sweet Corn": "الذرة الحلوة",
      "Fresh Garlic": "الثوم الطازج",
      "Cherry": "الكرز",
      "Eggplant": "الباذنجان",
      "Potato": "البطاطس",
      "Cabbage": "الملفوف",
      ...
      "Seedless Grapes": "العنب بدون بذور",
      "Sweet Cherry": "الكرز الحلو",
      "Yellow Onions": "البصل الأصفر"
    },
    months: {
      "Jan - Dec": "يناير - ديسمبر",
      "Feb - Jul": "فبراير - يوليو",
      "Apr - Jul": "أبريل - يوليو",
      "Feb - Aug": "فبراير - أغسطس",
      "Jul - Nov": "يوليو - نوفمبر",
      "Jun - Aug": "يونيو - أغسطس",
      "Nov - Jan": "نوفمبر - يناير"
    }
  },
  tr: {
    blog: "Blog",
    ...
    searchBtn: "Ara",
    situation: "HACİM DURUMU",
    fruitsVegs: "İran Taze Sebze ve Meyveleri",
    available: "Mevcut",
    limited: "Sınırlı",
    unavailable: "Mevcut Değil",
    viewDetails: "Detayları Gör →",
    allData: "Tüm Veriler",
    customsStats: "GÜMRÜK İSTATİSTİKLERİ",
    livePortStream: "Canlı Gümrük Akışı",
    terminals: "Terminaller",
    products: "Ürünler",
    quantity: "Miktar (ton)",
    loading: "Veriler yükleniyor...",
    allCustoms: "Tüm Gümrükler",
    astara: "Astara",
    bilehsavar: "Bilehsavar",
    priceInquiryTitle: "Ürün Fiyat Sorgulama",
    priceInquiryDesc: "Değerli İthalatçılarımız, Gilafruit ekibi İran taze meyve ve sebzeleri için en güncel gümrük teslim fiyatlarını almanıza yardımcı olmaya hazırdır.",
    callForPrice: "Fiyat Al",
    inWhatsApp: "WhatsApp'ta",
    shippingInquiryTitle: "Nakliye Fiyat Sorgulama",
    shippingInquiryDesc: "İran'dan dünyanın her yerine soğutmalı lojistik servis fiyatları için hızlı gümrük geçişli online teklifler alın.",
    sampleTitle: "Ücretsiz Numune Talebi",
    sampleDesc: "Gilafruit olarak ürün kalitemize son derece güveniyoruz. Satın almadan önce güvence edinmeniz için ücretsiz meyve ve sebze numunesi gönderiyoruz.",
    request: "Talep Et",
    readMore: "Devamını Oku",
    noResults: "Arama anahtar kelimesiyle eşleşen makale bulunamadı",
    noResultsSub: "Lütfen \"Kivi\" veya \"Sarımsak\" gibi diğer ürünleri aramayı deneyin.",
    productsNames: {
      "Kiwi": "Kivi",
      "Iceberg Lettuce": "Iceberg Marul",
      "Bell Pepper": "Dolmalık Biber",
      "Romaine Lettuce": "Romen Marul",
      "Celery": "Kereviz",
      "Broccoli": "Brokoli",
      "Watermelon": "Karpuz",
      "Tomato": "Domates",
  ...
  uz: {
    ...
    searchBtn: "Izlash",
    situation: "HOSIL HOLATI",
    fruitsVegs: "Eron meva va sabzavotlari",
    available: "Mavjud",
    limited: "Cheklangan",
    unavailable: "Mavjud emas",
    viewDetails: "Batafsil →",
    allData: "Barcha ma’lumotlar",
    customsStats: "BOJXONA STATISTIKASI",
    livePortStream: "Jonli bojxona portali oqimi",
    terminals: "Terminallar",
    products: "Mahsulotlar",
    quantity: "Hajm (tonna)",
    loading: "Yuklanmoqda...",
    allCustoms: "Barcha bojxonalar",
    astara: "Astara",
    bilehsavar: "Bilesuvar",
    priceInquiryTitle: "Mahsulot narxi so’rovi",
    priceInquiryDesc: "Hurmatli tadbirkorlar, bizning Gilafruit jamoamiz sizga Eron meva va sabzavotlari uchun eng so’nggi ulgurji narxlarni topishda yordam beradi.",
    callForPrice: "Narxni bilish",
    inWhatsApp: "WhatsAppda",
    shippingInquiryTitle: "Yetkazish narxi so’rovi",
    shippingInquiryDesc: "Eron muzlatgichli transport xizmatlari guruhidan tezkor narx taklifini online oling.",
    sampleTitle: "Namuna so’rash",
    sampleDesc: "Biz mahsulotlarimiz sifatiga ishonamiz, shu sababli buyurtma berishdan oldin bepul namuna yuborib ko’ramiz.",
    request: "So’rov yuborish",
    readMore: "Batafsil ma'lumot",
    noResults: "Kalit so'zlarga mos keladigan maqola topilmadi",
    noResultsSub: "Kivi yoki Sarimsoq kabi boshqa mahsulotlarni izlab ko'ring.",
    productsNames: {
      "Kiwi": "Kivi",
      "Iceberg Lettuce": "Aysberg salati",
      "Bell Pepper": "Bulg'or qalampiri",
      "Romaine Lettuce": "Romen salati",
      "Celery": "Selderey",
      "Broccoli": "Brokkoli",
      "Watermelon": "Tarvuz",
      "Tomato": "Pomidor",
      "Sweet Corn": "Makkajo'xori",
      "Fresh Garlic": "Yangi sarimsoq",
      "Cherry": "Gilos",
      "Eggplant": "Baqlajon",
      "Potato": "Kartoshka",
      "Cabbage": "Karam",
      ...
      "Seedless Grapes": "Kishmish uzum",
      "Sweet Cherry": "Shirin gilos",
      "Yellow Onions": "Sariq piyoz"
    },
    months: {
      "Jan - Dec": "Yan - Dek",
      "Feb - Jul": "Fev - Iyul",
  ...
  az: {
    ...
    searchBtn: "Axtar",
    situation: "LOGİSTİKA STATUSU",
    fruitsVegs: "İran Tərəvəz və Meyvələri",
    available: "Mövcuddur",
    limited: "Məhduddur",
    unavailable: "Yoxdur",
    viewDetails: "Ətraflı Bax →",
    allData: "Bütün Məlumatlar",
    customsStats: "GÖMRÜK STATİSTİKASI",
    livePortStream: "Canlı Gömrük Terminalı Yayımı",
    terminals: "Terminallar",
    products: "Məhsullar",
    quantity: "Həcm (ton)",
    loading: "Məlumat yüklənir...",
    allCustoms: "Bütün Gömrüklər",
    astara: "Astara",
    bilehsavar: "Biləsuvar",
    priceInquiryTitle: "Məhsul Qiymət Sorğusu",
    priceInquiryDesc: "Hörmətli Tacirlər, Gilafruit komandası sizə ən yeni İran meyvə və tərəvəz ixrac qiymətlərini təqdim etməyə hazırdır.",
    callForPrice: "Zəng Et",
    inWhatsApp: "WhatsApp-da",
    shippingInquiryTitle: "Çatdırılma Qiymət Sorğusu",
    shippingInquiryDesc: "İrandan dünyanın istənilən nöqtəsinə refrigeratlı loqistika qiymətləri üçün dərhal online təklif alın.",
    sampleTitle: "Ödənişsiz Nümunə Talebi",
    sampleDesc: "GilaFruit olaraq məhsullarımızın keyfiyyətinə güvənirik, buna görə də alıcılara tək tərəfli ödənişsiz nümunə təklif edirik.",
    request: "Tələb et",
    readMore: "Ətraflı oxu",
    noResults: "Axtarış meyarlarına uyğun məqalə tapılmadı",
    noResultsSub: "Kivi və ya Sarımsaq kimi digər məhsulları axtarmağı sınayın.",
    productsNames: {
      "Kiwi": "Kivi",
      "Iceberg Lettuce": "Aysberq salatı",
      "Bell Pepper": "Şirin bibər",
      "Romaine Lettuce": "Romen salatı",
      "Celery": "Kərəviz",
      "Broccoli": "Brokkoli",
      "Watermelon": "Qarpız",
      "Tomato": "Pomidor",
      "Sweet Corn": "Şirin qarğıdalı",
      "Fresh Garlic": "Təzə sarımsaq",
      "Cherry": "Gilas",
      "Eggplant": "Badımcan",
      "Potato": "Kartof",
      "Cabbage": "Kələm",
  ...
  hi: {
    ...
    searchBtn: "खोजें",
    situation: "आपूर्ति की स्थिति",
    fruitsVegs: "ईरानी फल और सब्जियां",
    available: "उपलब्ध",
    limited: "सीमित",
    unavailable: "उपलब्ध नहीं",
    viewDetails: "विवरण देखें →",
    allData: "सभी डेटा देखें",
    customsStats: "सीमा शुल्क आंकड़े",
    livePortStream: "लाइव सीमा शुल्क ट्रैक",
    terminals: "टर्मिनल",
    products: "उत्पाद",
    quantity: "मात्रा (टन)",
    loading: "डेटा लोड हो रहा है...",
    allCustoms: "सभी सीमा शुल्क",
    astara: "अस्तारा",
    bilehsavar: "बिलेहसवार",
    priceInquiryTitle: "ताज़ा उत्पाद मूल्य पूछताछ",
    priceInquiryDesc: "प्रिय व्यापारियों, हमारी गिलाफ़्रूट टीम आपको ईरानी फलों और सब्जियों की ताज़ा थोक कीमतें प्राप्त करने में मदद के लिए तत्पर है।",
    callForPrice: "मूल्य हेतु कॉल करें",
    inWhatsApp: "व्हाट्सएप चैट",
    shippingInquiryTitle: "शिपिंग लागत पूछताछ",
    shippingInquiryDesc: "ईरान से दुनिया भर के लिए रेफ्रिजेरेटed कंटेनर शिपिंग की त्वरित और लाइव ऑनलाइन उद्धरण प्राप्त करें।",
    sampleTitle: "उत्पाद सैंपल अनुरोध",
    sampleDesc: "हम उत्पाद गुणवत्ता आश्वस्त करते हैं, इसलिए थोक खरीद से पहले सभी गंभीर खरीदारों को मुफ्त सैंपल प्रदान करते हैं।",
    request: "अनुरोध करें",
    readMore: "और पढ़ें",
    noResults: "खोजे गए शब्दों के लिए कोई ब्लॉग लेख नहीं मिला",
    noResultsSub: "कृप्या \"कीवी\" या \"लहसुन\" जैसे उत्पादों को खोजने का प्रयास करें।",
    productsNames: {
      "Kiwi": "कीवी",
      ...
      "Cucumber": "खीरा",
      "Cauliflower": "फूलगोभी",
      "Seedless Grapes": "बेदाग अंगूर",
      "Sweet Cherry": "मीठी चेरी",
      "Yellow Onions": "पीला प्याज"
    },
    months: {
      "Jan - Dec": "जनवरी - दिसंबर",
      "Feb - Jul": "फरवरी - जुलाई",
      "Apr - Jul": "अप्रैल - जुलाई",
      "Feb - Aug": "फरवरी - अगस्त",
      "Jul - Nov": "जुलाई - नवंबर",
      "Jun - Aug": "जून - अगस्त",
      "Nov - Jan": "नवंबर - जनवरी"
  ...
  uk: {
    blog: "Блог",
    home: "Головна",
    searchPlaceholder: "Пошук публікацій...",
    searchBtn: "Пошук",
    situation: "СТАТУС ПОСТАВОК",
    fruitsVegs: "Експортні овочі та фрукти Ірану",
    available: "Доступно",
    limited: "Обмежено",
    unavailable: "Немає в наявності",
    viewDetails: "Детальніше →",
    allData: "Усі дані",
    customsStats: "МИТНА СТАТИСТИКА",
    livePortStream: "Прямий митний потік онлайн",
    terminals: "Терміналі",
    products: "Продукти",
    quantity: "Обсяг (т)",
    loading: "Завантаження...",
    allCustoms: "Всі пункти",
    astara: "Астара",
    bilehsavar: "Білясувар",
    priceInquiryTitle: "Запит ціни на продукцію",
    priceInquiryDesc: "Шановні партнери, компанія GilaFruit готова оперативно надати найсвіжіші оптові ціни на ринку Ірану.",
    callForPrice: "Зателефонувати",
    inWhatsApp: "В WhatsApp",
    shippingInquiryTitle: "Запит вартості доставки",
    shippingInquiryDesc: "Миттєве отримання цін для фрахтування рефрижераторних контейнерів з Ірану в будь-яку точку світу.",
    sampleTitle: "Запит зразків продукції",
    sampleDesc: "Ми пишаємось якістю своєї продукції та пропонуємо безкоштовні зразки перед оформленням великих партій.",
    request: "Надіслати запит",
    readMore: "Читати далі",
    noResults: "Не знайдено статей за цим запитом",
    noResultsSub: "Спробуйте інші запити, наприклад \"Ківі\" або \"Часник\".",
    productsNames: {
      "Kiwi": "Ківі",
      "Iceberg Lettuce": "Салат Айсберг",
      ...
      "Watermelon": "Кавун",
      "Tomato": "Томати",
      "Sweet Corn": "Кукурудза",
      "Fresh Garlic": "Свіжий часник",
      "Cherry": "Черешня",
      "Eggplant": "Баклажан",
      "Potato": "Картопля",
      "Cabbage": "Капуста",
      ...
      "Seedless Grapes": "Виноград Кишмиш",
      "Sweet Cherry": "Солодка черешня",
      "Yellow Onions": "Жовта цибуля"
    },
    months: {
      "Jan - Dec": "Січ - Груд",
      "Feb - Jul": "Лют - Лип",
...
export default function BlogScreen({ blogs, onNavigate }: BlogScreenProps) {
  const { getLBlog, language, direction } = useLanguage();
  const currentLang = language && BLOG_LOCALES[language] ? language : 'en';
  const loc = BLOG_LOCALES[currentLang];
  ...
  const localizedBlogsList = useMemo(() => {
    return activeBlogsList.map(getLBlog);
  }, [activeBlogsList, getLBlog]);
  ...
  const filteredArticles = useMemo(() => {
    return localizedBlogsList.filter((b) => {
  ...
  }, [localizedBlogsList, searchQuery]);
      ...
      <div className="bg-[#f2f4f1] border-y border-slate-200/60 py-4 mb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row md:items-center justify-between gap-2 text-left">
          ...
          <div className="flex items-center gap-1.5 text-xs text-slate-500 font-bold">
            ...
            <span className="text-slate-800 font-semibold">{loc.blog}</span>
          </div>
        </div>
      </div>
                ...
                {currentListProducts.map((p, idx) => (
                  <div key={idx} className="py-2.5 flex items-center justify-between gap-2.5 hover:bg-slate-50/40 px-1 rounded transition-colors text-xs">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="font-bold text-slate-800">{loc.productsNames[p.name] || p.name}</span>
                    </div>
                    <div className="flex items-center gap-2.5 flex-shrink-0">
                      <span className="text-[10.5px] text-slate-400 font-semibold">{loc.months[p.dateRange] || p.dateRange}</span>
                      <button
              ...
              <div className="grid grid-cols-3 gap-2 py-1 text-center relative min-h-[50px] items-center">
                ...
                {loadingCustoms ? (
                  <div className="col-span-3 py-6 flex flex-col items-center justify-center gap-2 text-slate-400">
                    ...
                    <span className="text-[10px] font-semibold italic">{loc.loading}</span>
                  </div>
                ) : (
                  <>
                    <div className="bg-[#fbfcfa] border border-slate-100 rounded-xl p-2.5">
                      <div className="text-[8.5px] text-slate-400 font-extrabold uppercase tracking-wider">{loc.terminals}</div>
                      <div className="text-sm font-bold text-slate-800 mt-1">{statsByTab.terminals}</div>
                    </div>
                    <div className="bg-[#fbfcfa] border border-slate-100 rounded-xl p-2.5">
                      <div className="text-[8.5px] text-slate-400 font-extrabold uppercase tracking-wider">{loc.products}</div>
                      <div className="text-sm font-bold text-slate-800 mt-1">{statsByTab.products}</div>
                    </div>
                    <div className="bg-[#fbfcfa] border border-slate-100 rounded-xl p-2.5">
                      <div className="text-[8.5px] text-slate-400 font-extrabold uppercase tracking-wider">{loc.quantity}</div>
          ...
          <div className="flex-1 space-y-1">
            ...
            {totalArticlesCount > 0 ? (
              ...
              <div className="py-24 text-center space-y-4 bg-slate-50 rounded-3xl border border-dashed border-slate-300">
                ...
                <p className="text-slate-800 font-bold font-display text-base">{loc.noResults}</p>
                <p className="text-slate-500 text-xs">{loc.noResultsSub}</p>
              </div>
            )}
