...
import { getHomeTranslations } from '../utils/homeTranslations';
...
export default function HomeScreen({
  ...
  const { getLProduct, getLBlog, language } = useLanguage();
  const tHome = getHomeTranslations(language);
  const products = rawProducts.map(getLProduct);
  const blogs = rawBlogs.map(getLBlog);
  ...
  const heroSlideImages = [
    "https://images.unsplash.com/photo-1585059895524-72359e061381?auto=format&fit=crop&q=80&w=800",
    "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&q=80&w=800",
    "https://images.unsplash.com/photo-1610348725531-843dff14f9df?auto=format&fit=crop&q=80&w=800"
  ];

  const heroSlides = tHome.hero.slides.map((slide, idx) => ({
    ...slide,
  ...
  const officialFeatures = tHome.features.items;

  // Specific 12 fruits and vegetables showcasing exact labels & borders as seen in screenshot
  const exportShowcaseProducts = [
    { id: "e1", name: tHome.portfolio.productsNames.e1, tag: tHome.portfolio.productTags.Kiwi, slug: "hayward-kiwifruit", image: "https://images.unsplash.com/photo-1585059895524-72359e061381?auto=format&fit=crop&q=80&w=500" },
    { id: "e2", name: tHome.portfolio.productsNames.e2, tag: tHome.portfolio.productTags.Garlic, slug: "fresh-garlic", image: "https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?auto=format&fit=crop&q=80&w=500" },
    { id: "e3", name: tHome.portfolio.productsNames.e3, tag: tHome.portfolio.productTags.Watermelon, slug: "export-watermelon", image: "https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&q=80&w=500" },
    { id: "e4", name: tHome.portfolio.productsNames.e4, tag: tHome.portfolio.productTags.Lettuce, slug: "lettuce-export", image: "https://images.unsplash.com/photo-1629115911440-e2ce8d9ece45?auto=format&fit=crop&q=80&w=500" },
    { id: "e5", name: tHome.portfolio.productsNames.e5, tag: tHome.portfolio.productTags.Pepper, slug: "bell-pepper-export", image: "https://images.unsplash.com/photo-1563565315-f5b994071ec2?auto=format&fit=crop&q=80&w=500" },
    { id: "e6", name: tHome.portfolio.productsNames.e6, tag: tHome.portfolio.productTags.Tomato, slug: "greenhouse-tomatoes", image: "https://images.unsplash.com/photo-1595855759920-86582396756a?auto=format&fit=crop&q=80&w=500" },
    { id: "e7", name: tHome.portfolio.productsNames.e7, tag: tHome.portfolio.productTags.Parsley, slug: "parsley-export", image: "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&q=80&w=500" },
    { id: "e8", name: tHome.portfolio.productsNames.e8, tag: tHome.portfolio.productTags.Dill, slug: "dill-export", image: "https://images.unsplash.com/photo-1588711928096-7d60914da6bf?auto=format&fit=crop&q=80&w=500" },
    { id: "e9", name: tHome.portfolio.productsNames.e9, tag: tHome.portfolio.productTags.Garlic, slug: "dry-garlic-export", image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?auto=format&fit=crop&q=80&w=500" },
    { id: "e10", name: tHome.portfolio.productsNames.e10, tag: tHome.portfolio.productTags.Grapes, slug: "seedless-grapes", image: "https://images.unsplash.com/photo-1537640538966-79f369143f8f?auto=format&fit=crop&q=80&w=500" },
    { id: "e11", name: tHome.portfolio.productsNames.e11, tag: tHome.portfolio.productTags.Broccoli, slug: "green-broccoli", image: "https://images.unsplash.com/photo-1584269600464-37b1b58a9fe7?auto=format&fit=crop&q=80&w=500" },
    { id: "e12", name: tHome.portfolio.productsNames.e12, tag: tHome.portfolio.productTags.Cherries, slug: "sweet-cherries", image: "https://images.unsplash.com/photo-1527661591475-527312dd65f5?auto=format&fit=crop&q=80&w=500" }
  ];
  ...
  return (
    <div className="flex flex-col space-y-0 pb-16 animate-fade-in bg-slate-50" id="home-view">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200/60 hover:shadow-md transition-all text-left flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h4 className="font-display font-bold text-slate-800 text-lg">{tHome.highlights.items[0].title}</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
                  {tHome.highlights.items[0].desc}
                </p>
              </div>
              <span className="text-[10px] uppercase font-bold text-emerald-800 tracking-wider pt-4 block">{tHome.highlights.items[0].footer}</span>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200/60 hover:shadow-md transition-all text-left flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h4 className="font-display font-bold text-slate-800 text-lg">{tHome.highlights.items[1].title}</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
                  {tHome.highlights.items[1].desc}
                </p>
              </div>
              <span className="text-[10px] uppercase font-bold text-emerald-800 tracking-wider pt-4 block">{tHome.highlights.items[1].footer}</span>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200/60 hover:shadow-md transition-all text-left flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h4 className="font-display font-bold text-slate-800 text-lg">{tHome.highlights.items[2].title}</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
                  {tHome.highlights.items[2].desc}
                </p>
              </div>
              <span className="text-[10px] uppercase font-bold text-emerald-800 tracking-wider pt-4 block">{tHome.highlights.items[2].footer}</span>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="bg-white text-slate-800 rounded-[2.5rem] p-8 sm:p-12 md:p-14 shadow-[0_30px_70px_-15px_rgba(0,0,0,0.65)] border border-slate-150 relative overflow-hidden text-left hover:border-emerald-100 transition-all duration-500">
            ...
            <h2 className="font-display text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-snug">
              <span className="text-[#135d37] font-black mr-1">{tHome.gateway.headingPart1}</span> {tHome.gateway.headingPart2}
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
              ...
              <div className="bg-slate-50/70 hover:bg-white border border-slate-200/50 hover:border-emerald-500/30 p-8 rounded-3xl transition-all duration-300 flex flex-col items-center text-center justify-between shadow-[0_4px_12px_rgba(0,0,0,0.01)] hover:shadow-xl group hover:-translate-y-1">
                <div className="space-y-4 flex flex-col items-center">
                  ...
                  <h4 className="font-display font-black text-slate-800 text-lg transition-colors group-hover:text-emerald-700">{tHome.gateway.calendar.title}</h4>
                  <p className="text-xs text-slate-500 leading-relaxed max-w-xs">
                    {tHome.gateway.calendar.desc}
                  </p>
                </div>
                ...
                >
                  ...
                  <span>{tHome.gateway.calendar.btn}</span>
                </button>
              </div>
              ...
              <div className="bg-slate-50/70 hover:bg-white border border-slate-200/50 hover:border-emerald-500/30 p-8 rounded-3xl transition-all duration-300 flex flex-col items-center text-center justify-between shadow-[0_4px_12px_rgba(0,0,0,0.01)] hover:shadow-xl group hover:-translate-y-1">
                <div className="space-y-4 flex flex-col items-center">
                  ...
                  <h4 className="font-display font-black text-slate-800 text-lg transition-colors group-hover:text-emerald-700">{tHome.gateway.products.title}</h4>
                  <p className="text-xs text-slate-500 leading-relaxed max-w-xs">
                    {tHome.gateway.products.desc}
                  </p>
                </div>
                ...
                >
                  ...
                  <span>{tHome.gateway.products.btn}</span>
                </button>
              </div>
            ...
            <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-2xl border-[6px] border-white max-w-md bg-slate-900 group">
              ...
              <div className="absolute bottom-4 inset-x-4 bg-slate-950/75 backdrop-blur-md rounded-2xl p-4 border border-slate-800 flex flex-col space-y-1">
                <span className="text-[10px] uppercase font-mono font-bold tracking-widest text-amber-400">
                  {tHome.features.sliderCaption} 0{activeFeatureSlide + 1}
                </span>
                <span className="text-xs font-bold text-white tracking-wide">
                  {tHome.features.stages[activeFeatureSlide]}
                </span>
              </div>
      ...
      <section className="bg-gradient-to-br from-[#022c22] via-[#043e2f] to-[#011c14] py-24 text-white rounded-[50px] shadow-[inset_0_4px_30px_rgba(0,0,0,0.4)] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-16 relative z-10">
              ...
              >
                <div className="relative h-56 overflow-hidden">
                  ...
                  <span className="absolute top-4 left-4 px-3.5 py-1.5 bg-slate-950/95 text-amber-400 border border-amber-400/35 rounded-xl text-[8.5px] uppercase font-black tracking-widest font-mono shadow-lg">
                    ✨ {prod.tag} {tHome.portfolio.stamp}
                  </span>
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-3 border-t border-emerald-800/40 flex items-center justify-between">
                    ...
                    >
                      <span>{tHome.portfolio.specsBtn || "Specifications"}</span>
          ...
          <div className="pt-8">
            ...
            >
              {tHome.portfolio.allProductsBtn || "📊 View Full Export Catalog Directory"}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="w-full max-w-sm bg-white border-4 border-emerald-800 rounded-3xl p-10 flex flex-col items-center justify-center text-center shadow-xl relative aspect-square">
              ...
              <span className="text-xl font-display font-bold uppercase tracking-widest text-slate-800 my-2">{tHome.story.yearsText}</span>
              <span className="text-xs text-slate-500 font-mono tracking-widest">{tHome.story.outcomeText}</span>
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-2">
              <span className="text-xs text-amber-600 font-bold uppercase tracking-widest block">{tHome.story.badge}</span>
              <h2 className="font-display text-3xl sm:text-4xl font-black text-slate-900 leading-none">
                {tHome.story.titlePart1} <br />
                <span className="text-emerald-800">{tHome.story.titlePart2}</span>
              </h2>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-slate-200">
              <div className="text-center sm:text-left">
                ...
                <span className="text-[10px] sm:text-xs text-slate-500 uppercase tracking-wider font-semibold block">{tHome.story.stats.gardens}</span>
              </div>
              <div className="text-center sm:text-left">
                <span className="block font-display text-2xl sm:text-4xl font-black text-emerald-800 font-mono">+30</span>
                <span className="text-[10px] sm:text-xs text-slate-500 uppercase tracking-wider font-semibold block">{tHome.story.stats.products}</span>
              </div>
              <div className="text-center sm:text-left">
                <span className="block font-display text-2xl sm:text-4xl font-black text-emerald-800 font-mono">+20</span>
                <span className="text-[10px] sm:text-xs text-slate-500 uppercase tracking-wider font-semibold block">{tHome.story.stats.partners}</span>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 bg-slate-900 text-white overflow-hidden text-left">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <div className="max-w-xl space-y-2 text-left">
            <span className="text-xs uppercase tracking-widest font-bold text-amber-400 block">{tHome.freshness.badge}</span>
            <h3 className="font-display text-2xl sm:text-3.5xl font-black text-white leading-tight">
              {tHome.freshness.title}
            </h3>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center space-y-12">
        <div className="space-y-4">
          <span className="text-xs uppercase tracking-widest font-bold text-emerald-800 block">{tHome.certifications.badge}</span>
          <h2 className="font-display text-3xl sm:text-4.5xl font-black text-slate-900 leading-none">
            {tHome.certifications.title}
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch text-left">
            ...
            <div className="lg:col-span-5 relative bg-slate-50 rounded-2xl p-6 pt-12 space-y-4 border border-slate-100 flex flex-col justify-between min-h-[300px]">
                ...
                <div className="space-y-4">
                  <div className="text-center sm:text-left">
                    <span className="text-[10px] font-bold text-emerald-800 uppercase tracking-widest block mb-1">
                      {tHome.certifications.testimonialHeading || "Wholesale Partner Review"}
                    </span>
              ...
              <div className="flex justify-center sm:justify-start gap-2 pt-2">
                ...
                >
                  {tHome.certifications.testimonialButtons?.back || "◀ Back"}
                </button>
                <button 
                  onClick={handleNextTestimonial}
                  className="px-3 py-1.5 bg-white border border-slate-200 text-slate-700 text-xs rounded-xl hover:bg-slate-100 font-sans font-medium transition-all cursor-pointer shadow-xs"
                >
                  {tHome.certifications.testimonialButtons?.next || "Next ▶"}
                </button>
              </div>
            </div>
