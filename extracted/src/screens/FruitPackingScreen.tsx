...
export default function FruitPackingScreen({ onNavigate }: FruitPackingScreenProps) {
  ...
  const fruitProductBoxes = [
    {
      title: d("Single Row Kiwis", "کیوی تک ردیف"),
      subtitle: d("Premium Red Crate", "سبد سرخ ممتاز"),
      image: "https://images.unsplash.com/photo-1591084728795-1149f32d9866?auto=format&fit=crop&q=80&w=400",
      desc: d("Optimized single-row cell grid for Hayward Kiwifruits, preventing rubbing or weight pressure on skin.", "قالب سلولی تک‌ردیفه طراحی‌شده برای کیوی هایوارد جهت جلوگیری از سائیدگی و وارد آمدن فشار فیزیکی به پوست میوه.")
    },
    {
      title: d("Luxury Grape Packaging", "بسته‌بندی انگور لوکس"),
      subtitle: d("Wide White Crate", "سبد سفید عریض"),
      image: "https://images.unsplash.com/photo-1537640538966-79f369143f8f?auto=format&fit=crop&q=80&w=400",
      desc: d("Specially padded, hyper-aerated compartments loaded horizontally to preserve Caspian grapes freshness.", "محفظه‌های دارای تهویه هوا بالا همراه ضربه‌گیرهای نرم جهت چیدمان افقی و تضمین شادابی انگورهای صادراتی.")
    },
    {
      title: d("Export Quality Mandarins", "نارنگی مرغوب صادراتی"),
      subtitle: d("Exclusive Double-Row Crate", "سبد اختصاصی دوردیفه"),
      image: "https://images.unsplash.com/photo-1611080626919-7cf5a9dbab5b?auto=format&fit=crop&q=80&w=400",
      desc: d("Heavy-duty double-row plastic lattice for direct citrus dispatch, providing structural crush defense.", "توری پلاستیکی پایدار و مقاوم دو‌ردیفه برای ارسال انواع مرکبات با حداکثر توان مقابله با هرگونه آسیب فیزیکی.")
    }
  ];
  ...
  const fruitBrandedFrames = [
    {
      id: "frame-kiwi-4kg",
      title: d("4 KG PLASTIC BASKET PACKING", "بسته‌بندی سبد پلاستیکی ۴ کیلوگرمی"),
      badge: d("Kiwi", "کیوی"),
      tag: d("Grade A", "درجه یک ممتاز"),
    ...
    },
    {
      ...
      title: d("EXPORT OF VARIOUS TYPES OF LETTUCE FROM IRAN", "صادرات انواع کاهو صادراتی از ایران"),
      badge: d("Kiwi", "کاهو"),
      tag: d("Verified", "تایید شده"),
    ...
    {
      id: "frame-white-10kg",
      title: d("WHITE 10 KG PACKAGING", "بسته‌بندی ۱۰ کیلوگرمی سفید"),
      badge: d("Kiwi", "کیوی"),
      tag: d("Pure Select", "دست‌چین خالص"),
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-900 selection:bg-emerald-800 selection:text-white" id="fruit-packing-root" dir={direction}>
      ...
      <div className="relative bg-[#01261d] text-white overflow-hidden pt-24 pb-20 sm:pt-[112px] sm:pb-28 md:pt-[148px] text-center" id="fruit-packing-hero">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 flex flex-col items-center justify-center space-y-4">
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-black tracking-tight max-w-4xl leading-tight text-white drop-shadow-sm">
            {d("Gilafruit: Present Your Fruits to the World with Freshness and Quality", "گیلافروت: معرفی میوه‌های صادراتی به جهان با حفظ بالاترین کیفیت و تازگی")}
          </h1>
          <p className="max-w-3xl text-emerald-300 text-xs sm:text-sm font-semibold leading-relaxed pt-1">
            {d(
              ...
              "حفظ طراوت اولویت اصلی ما با راهکارهای نوآورانه بسته‌بندی میوه است. روش‌های پیشرفته ما تازگی را در طول ارسال محصولات صادراتی تضمین می‌کند. ما بسته‌بندی‌ها را به منظور افزایش کیفیت نهایی صادرات بهینه‌سازی می‌کنیم."
            )}
          </p>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-slate-200/60 flex flex-col space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-sans">
              {d(
                ...
                "با استفاده از لایه‌های محافظ تخصصی ما، محصول نهایی را با همان کیفیتی تحویل مشتری دهید که در روز برداشت از درخت داشته است."
              )}
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16" id="intro-text-section">
        <div className="space-y-12">
          ...
          <div className={`max-w-5xl mx-auto text-slate-700 text-xs sm:text-sm leading-relaxed text-justify space-y-4 ${isRtl ? 'text-right' : 'text-left'}`}>
            <p>
              {d(
                "With a distinguished history in the fruit export industry, Gilafruit offers a comprehensive range of packaging solutions to maintain the freshness and quality of fruits during transportation and captivate international customers. Utilizing our expertise and experience, we design and manufacture containers using high-quality materials and specifically tailored to the needs of each type of fruit.",
                "گیلافروت با سابقه‌ای درخشان در صنعت صادرات میوه ایرانی، طیف کاملی از طرح‌های بسته‌بندی نوین را برای حفظ کیفیت در طول حمل و نگهداری و جذب خریداران بین‌المللی ارائه می‌نماید. ما با استفاده از تخصص و تجارب خود بسته‌بندی‌ها را با مرغوب‌ترین مواد اولیه و متناسب با حساسیت‌های فیزیکی هر میوه طراحی و تولید می‌کنیم."
              )}
            </p>
            <p>
              {d(
                "Our understanding of the crucial role of proper presentation in fruit export drives our commitment to providing solutions that help you preserve the freshness, vibrancy, and flavor of your fruits throughout their journey to global markets. By choosing Gilafruit, you can reap numerous benefits, including:",
                "درک عمیق ما از نقش حیاتی ارائه شکیل در فرآیند صادرات میوه، مبنای تعهد ماست تا تازگی، رنگ و طعم واقعی محصولات جذاب شما را تا رسیدن به بازارهای جهانی زنده نگه داریم. با انتخاب گیلافروت از مزایای فراوانی بهره‌مند می‌شوید از جمله:"
              )}
            </p>
            ...
            <div className="lg:col-span-4 bg-[#014134] text-white rounded-3xl p-8 sm:p-10 flex flex-col justify-between shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <h3 className={`font-display font-black text-2xl sm:text-3xl leading-tight tracking-tight ${isRtl ? 'text-right' : 'text-left'}`}>
                  {d("Sustainable Packaging for Iran's Sustainable Fruits", "بسته‌بندی پایدار برای میوه‌های فاخر ایرانی")}
                </h3>
              ...
              <div className="space-y-4 pt-12 relative z-10">
                ...
                <span className={`text-[10px] font-mono text-emerald-300 tracking-wider block font-bold ${isRtl ? 'text-right' : 'text-left'}`}>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="font-display font-black text-2xl sm:text-3xl text-emerald-950 uppercase tracking-tight">
            {d(
              ...
              "گیلافروت: استانداردهای جهانی، کیفیت بی‌رقیب در بسته‌بندی میوه"
            )}
          </h2>
