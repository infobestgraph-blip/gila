...
export default function BlogDetailScreen({ article, allArticles, onNavigate }: BlogDetailScreenProps) {
      ...
      <div className="bg-[#f0f3f0] border-y border-slate-200/75 py-4 mb-8 text-left">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 text-[11px] text-slate-500 font-bold whitespace-nowrap">
            <span className="hover:text-emerald-800 cursor-pointer transition-colors" onClick={() => onNavigate('#/')}>Home</span>
            <span>»</span>
            <span className="hover:text-emerald-800 cursor-pointer transition-colors" onClick={() => onNavigate('#/blog')}>Blog</span>
            <span>»</span>
            <span className="hover:text-emerald-800 cursor-pointer transition-colors" onClick={() => onNavigate('#/blog')}>Articles</span>
            <span>»</span>
            <span className="text-[#1a8a42] font-semibold">Export</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="w-full lg:w-[320px] xl:w-[350px] flex-shrink-0 space-y-7 text-left order-2 lg:order-1" id="blog-sidebar">
              ...
              <div className="p-4 max-h-[300px] overflow-y-auto divide-y divide-slate-100/80 custom-scrollbar">
                {currentListProducts.map((p, idx) => (
                  <div key={idx} className="py-2.5 flex items-center justify-between gap-1.5 hover:bg-slate-50 px-1 rounded transition-colors text-xs">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] text-slate-400 font-bold">{p.dateRange}</span>
                      <button
              ...
              <div className="grid grid-cols-3 gap-1.5 py-0.5 text-center relative min-h-[45px] items-center">
                {loadingCustoms ? (
                  <div className="col-span-3 py-4 flex flex-col items-center justify-center gap-1.5 text-slate-400">
                    ...
                    <span className="text-[9px] font-semibold italic">Loading...</span>
                  </div>
                ) : (
                  <>
                    <div className="bg-[#fbfcfa] border border-slate-100 rounded-xl p-2">
                      <div className="text-[8px] text-slate-400 font-black uppercase tracking-wider">Terminals</div>
                      <div className="text-xs font-bold text-slate-800 mt-0.5">{statsByTab.terminals}</div>
                    </div>
                    <div className="bg-[#fbfcfa] border border-slate-100 rounded-xl p-2">
                      <div className="text-[8px] text-slate-400 font-black uppercase tracking-wider">Products</div>
                      <div className="text-xs font-bold text-slate-800 mt-0.5">{statsByTab.products}</div>
                    </div>
                    <div className="bg-[#fbfcfa] border border-slate-100 rounded-xl p-2">
                      <div className="text-[8px] text-slate-400 font-black uppercase tracking-wider">Quantity</div>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-5 shadow-sm space-y-4">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed">
                Esteemed Traders, Our export division is ready to assist you in getting up-to-date daily pricing for premium Iranian fruits & vegetables.
              </p>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-5 shadow-sm space-y-4">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed">
                We make international logistics straightforward. Get instant reefer container and truck land transit pricing from northern Iran.
              </p>
              <div className="bg-slate-50 rounded-2xl p-3 flex items-center justify-center border border-slate-100">
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-5 shadow-sm space-y-4">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed">
                Confirm GilaFruit standards yourself! Request premium hand-picked kiwi or garlic samples delivered directly to your foreign office.
              </p>
              <div className="bg-slate-50 rounded-2xl p-3 flex items-center justify-center border border-slate-100">
          ...
          <div className="flex-1 w-full bg-white border border-slate-100/90 rounded-3xl p-5 sm:p-8 md:p-10 shadow-sm text-left order-1 lg:order-2">
              ...
              <div className="space-y-8">
                ...
                <div className="relative h-64 sm:h-96 rounded-3xl overflow-hidden border border-slate-200 shadow-md group">
                  <img 
                    ...
                    alt="Buying and importing Iranian Kiwi to Russia"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent flex flex-col justify-between p-4 sm:p-6 text-white font-sans">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-slate-200 font-semibold border-t border-white/10 pt-2 font-mono">
                        ...
                        <span>Buying and importing Iranian Kiwi to Russia</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3.5 border-b border-slate-100 pb-6">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-xs text-slate-500 font-bold uppercase tracking-wider">
                    ...
                    <span>•</span>
                    <span className="flex items-center gap-1 bg-emerald-50 text-emerald-800 px-2 py-0.5 rounded uppercase">
                ...
                <div className="bg-slate-50 border border-slate-150 rounded-2xl p-4 sm:p-5 text-left space-y-3">
                  ...
                  <ol className="space-y-2 text-xs text-slate-600 font-semibold list-decimal pl-4">
                    <li>
                      <button onClick={() => scrollToHeading('sec-opportunities')} className="hover:text-[#1a8a42] hover:underline text-left">
                        Comprehensive Guide to Buying Kiwi for Import to Russia: Bulk Supply Opportunities with GilaFruit
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-exports')} className="hover:text-[#1a8a42] hover:underline text-left">
                        Iranian Kiwi Exports: Analyzing Market Opportunities for Russian Importers
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-standards')} className="hover:text-[#1a8a42] hover:underline text-left">
                        Quality Standards: The Gateway for Kiwi Import to Russia (Crucial for Buyers)
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-certificates')} className="hover:text-[#1a8a42] hover:underline text-left">
                        The Importance of International Certificates and Phytosanitary Requirements
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-notes')} className="hover:text-[#1a8a42] hover:underline text-left">
                        Technical Notes on Super-Luxe Iranian Kiwi
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-shipping')} className="hover:text-[#1a8a42] hover:underline text-left">
                        Shipping and Clearance: The Process of Importing Kiwi to Russia
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-customs-code')} className="hover:text-[#1a8a42] hover:underline text-left">
                        HS Code and Trade Arrangements
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-advantage')} className="hover:text-[#1a8a42] hover:underline text-left">
                        GilaFruit's Competitive Advantage: A Reliable Choice for Bulk Purchase Of Iranian Kiwi
                      </button>
                    </li>
                    <li>
                      <button onClick={() => scrollToHeading('sec-conclusion')} className="hover:text-[#1a8a42] hover:underline text-left">
                ...
                <div className="space-y-2" id="sec-opportunities">
                  <h6 className="text-[10.5px] text-[#1a8a42] font-black tracking-widest uppercase">GilaFruit Video Channel</h6>
                    ...
                    {videoPlaying ? (
                      <div className="w-full h-full flex flex-col items-center justify-center text-white p-6 space-y-4">
                        ...
                        <div className="text-center">
                          <p className="font-bold text-sm">Loading Premium Video Feed...</p>
                          <p className="text-xs text-slate-400 mt-1">GilaFruit Kiwi Sorting & Optical Weight Calibration Facility</p>
                        </div>
                        <button 
                          onClick={() => setVideoPlaying(false)}
                          className="px-4 py-1.5 bg-white/10 hover:bg-white/20 border border-white/20 text-white rounded-lg text-xs font-bold transition-all"
                        >
                          Pause Stream
                        </button>
                      </div>
                      ...
                      <>
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center text-white space-y-3 p-4">
                          <button 
                            ...
                            className="w-16 h-16 bg-[#1a8a42] hover:bg-emerald-600 rounded-full flex items-center justify-center text-white transition-all scale-95 hover:scale-100 shadow-lg group-pointer cursor-custom border-2 border-white/60"
                          >
                            <Play className="w-7 h-7 fill-current ml-1" />
                          </button>
                          <div className="text-center">
                            <h4 className="font-display font-black text-sm uppercase tracking-wide">
                              Video Presentation: kiwi Sorting & Packaging
                            </h4>
                            <p className="text-[11px] text-emerald-200 font-bold font-mono uppercase mt-1">
                              Duration: 3:45 | High Quality Sorter S600
                            </p>
                          </div>
                        </div>
                      </>
                ...
                <div className="space-y-2">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                    <img 
                      ...
                      alt="Best Super Luxe Iranian Kiwi Quality for import to Russia"
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    Best Super Luxe Iranian Kiwi Quality for import to Russia by GilaFruit
                  </p>
                </div>

                <p className="text-slate-650 leading-relaxed text-sm">
                  Iranian kiwi is rich in vitamins and copper, promoting healthy cell function. Consequently, it enjoys high popularity in the Russian domestic market, leading to substantial annual sales and export of Iranian kiwi to Russia.
                </p>
                ...
                <div className="space-y-4 pt-4" id="sec-exports">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm text-justify">
                    Iran holds the fifth rank globally in kiwi production, creating excellent opportunities for buying kiwi for import to Russia. Iranian kiwi, especially the Super-Luxe Iranian kiwi, has gained traction in countries like Russia due to its unique flavor and quality.
                  </p>
                  <p className="text-slate-650 leading-relaxed text-sm text-justify">
                    Russia imports Iranian kiwi every year, with imports typically starting in October and continuing until May. Companies commonly import kiwi to Russia via land routes, using refrigerated trailers or through Caspian Sea ports. They load the fruit from cold storages in northern cities and transport it across the Astara, Bileh Savar, and Norduz borders to Russia.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                    <img 
                      ...
                      alt="Successful cargo arrival of Iranian Kiwi"
                      className="w-full h-64 object-cover"
                    />
                    <div className="absolute bottom-0 inset-x-0 bg-black/60 backdrop-blur-sm p-2 text-white flex justify-between text-[11px] font-mono font-bold">
                      <span>www.GilaFruit.com</span>
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    Successful cargo arrival and clearance of Iranian Kiwi at Astrakhan port, Russia
                  </p>
                </div>
                ...
                <div className="bg-slate-50 border-l-4 border-[#1a8a42] p-4 rounded-r-xl">
                  <p className="text-xs sm:text-sm font-bold text-slate-800 mb-2">
                    The following Russian cities are major hubs for Iranian kiwi in their fruit and vegetable markets:
                  </p>
                  <ul className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs text-slate-650 font-bold pl-2 list-none">
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Moscow
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Saint Petersburg
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Novosibirsk
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Yekaterinburg
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Nizhny Novgorod
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Samara
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Kazan
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Omsk
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Chelyabinsk
                    </li>
                    <li className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#1a8a42]" /> Rostov-on-Don
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-4 pt-4" id="sec-standards">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm">
                    For successful kiwi import to Russia, product quality and packaging standards are of vital importance. Importers must pay close attention to the following points to minimize the risk of consignment halts at Russian customs:
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                    <img 
                      ...
                      alt="Standard and durable kiwi packaging"
                      className="w-full h-64 object-cover"
                    />
                    <div className="absolute bottom-0 inset-x-0 bg-black/60 backdrop-blur-sm p-2 text-white flex justify-between text-[11px] font-mono font-bold">
                      <span>www.GilaFruit.com</span>
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    Standard and durable kiwi packaging for long-distance import to Russia
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4" id="sec-certificates">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm text-justify">
                    GilaFruit (Sabz Gostaran Gilan Fruit), fully aware of the Russian Federal Phytosanitary regulations, supplies products with all necessary approvals. Your supplier must be able to provide the following key certifications:
                  </p>

                  <ol className="space-y-4 text-xs sm:text-sm text-slate-650 pl-4 list-decimal font-semibold">
                    <li>
                      <span className="text-slate-900 font-black">Phytosanitary Certificate:</span> Issued by the Iranian Plant Protection Organization, this certificate guarantees the product is free from pests and diseases. This document is essential for customs clearance in Russia.
                    </li>
                    <li>
                      <span className="text-slate-900 font-black">International Standards (e.g., GlobalGAP):</span> While not mandatory, providing evidence of adherence to global standards (especially concerning cultivation farms) for exported kiwi significantly boosts the confidence of Russian buyers.
                    </li>
                    <li>
                      <span className="text-slate-900 font-black">Product Authenticity Guarantee:</span> The kiwi supplied for import to Russia must be uniform in size, color, and taste, matching the agreed-upon sample.
                    </li>
                  </ol>
                </div>
                ...
                <div className="space-y-2">
                  <div className="bg-slate-50 border border-slate-150 rounded-2xl p-4 sm:p-5">
                    <h5 className="font-display font-black text-[#1a8a42] text-xs uppercase tracking-wider text-center mb-4 flex items-center justify-center gap-1.5">
                      ...
                      Phytosanitary Document Control Center (12 Keys)
                    </h5>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2.5">
                      {certificatesGrid.map((cert, idx) => (
                        <div key={idx} className="bg-white border-2 border-emerald-120 hover:border-emerald-600 rounded-xl p-2.5 text-center transition-all shadow-xs space-y-1">
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    Phytosanitary certificate and required documents for Buying Kiwi for Import to Russia
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4" id="sec-notes">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm text-justify">
                    The export kiwi from Iran (Super-Luxe) is usually selected from the Hayward variety and, more recently, the Gold variety. When you buy kiwi for import to Russia, consider these factors:
                  </p>

                  <ul className="space-y-3.5 text-xs sm:text-sm pl-4 list-disc text-slate-650 font-semibold">
                    <li>
                      <span className="text-slate-900 font-black">Calibration (Size):</span> The kiwi must be calibrated according to international standards, ensuring uniformity of size within a basket or cartoon. This is particularly important for the Russian wholesale market, which demands product consistency.
                    </li>
                    <li>
                      <span className="text-slate-900 font-black">Packaging (For Long Distances):</span> The packaging design for Iranian kiwi, especially for import to Russia which involves long transit times, must be highly durable. It needs to be stackable to resist pressure and reduce volume, which directly impacts the export price of kiwi to Russia.
                    </li>
                    <li>
                      <span className="text-slate-900 font-black">Cold Chain Management:</span> Kiwi must be stored and transported at temperatures between 0°C and -1°C. Your supplier must ensure the cold chain is maintained from harvest until arrival at the Russian destination.
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-2">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                    <img 
                      ...
                      alt="Grading and calibration of export kiwi"
                      className="w-full h-64 object-cover"
                    />
                    <div className="absolute bottom-0 inset-x-0 bg-black/60 backdrop-blur-sm p-2 text-white flex justify-between text-[11px] font-mono font-bold">
                      <span>www.GilaFruit.com</span>
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    Grading and calibration of export kiwi; ensuring uniformity for Bulk Purchase of Iranian Kiwi
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4" id="sec-shipping">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm text-justify">
                    Importing kiwi to Russia can be carried out using various methods, including land, sea, and air freight.
                  </p>
                    ...
                    <table className="w-full text-left text-xs sm:text-sm border-collapse">
                      <thead>
                        <tr className="bg-[#1a8a42]/10 text-[#1a8a42] border-b border-slate-200">
                          <th className="p-3 font-extrabold uppercase">Shipping Method</th>
                          <th className="p-3 font-extrabold uppercase">Pros and Cons</th>
                          <th className="p-3 font-extrabold uppercase">Commercial Notes for Kiwi Import</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-slate-150 font-semibold text-slate-750">
                        <tr>
                          <td className="p-3 font-black text-slate-905 bg-[#fafcf9] border-r border-slate-100">Land Freight</td>
                          <td className="p-3">The most cost-effective and widely used method.</td>
                          <td className="p-3">Requires standard refrigerated trailers. The main routes pass through Azerbaijan (Astara and Bileh Savar borders) and enter the Republic of Dagestan, Russia.</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-black text-slate-950 bg-[#fafcf9] border-r border-slate-100">Sea Freight</td>
                          <td className="p-3">Cost-efficient for high volumes.</td>
                          <td className="p-3">Utilizes the Caspian Sea ports; goods are typically unloaded at the Russian port of Astrakhan before being forwarded to inner Russian cities.</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-black text-slate-950 bg-[#fafcf9] border-r border-slate-100">Air Freight</td>
                          <td className="p-3">The fastest method.</td>
                          <td className="p-3 text-red-700">Extremely high cost. Used only for small samples or when transit speed is absolutely critical.</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                    <img 
                      ...
                      alt="Refrigerated truck carrying Iranian Kiwi"
                      className="w-full h-64 object-cover"
                    />
                    <div className="absolute bottom-0 inset-x-0 bg-black/60 backdrop-blur-sm p-2 text-white flex justify-between text-[11px] font-mono font-bold">
                      <span>www.GilaFruit.com</span>
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    Refrigerated truck carrying Iranian Kiwi via Astara border on the way to Russia
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4" id="sec-customs-code">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm text-justify">
                    For any kiwi import to Russia, importers must be aware of the HS Code (Harmonized System Code) for kiwi. The global code for fresh kiwi is typically <strong className="text-slate-950 font-black">081050</strong>. Knowing this code facilitates the calculation of customs duties and Russia's Value Added Tax (VAT). Understanding the Iran-Russia trade arrangements, including any preferential trade agreements, can help reduce final costs and make the export price of kiwi to Russia more competitive.
                  </p>
                </div>

                {/* MAIN GREEN WHATSAPP ADVICE FORM */}
                <div className="bg-[#1a8a42]/95 text-white rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-lg border-2 border-emerald-500">
                  ...
                  <div className="relative z-10 space-y-4">
                    ...
                    {adviceSubmitted ? (
                      <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center space-y-2 border border-white/20 animate-fade-in">
                        ...
                        <h5 className="font-bold text-sm">Advice Inquiry Sent Successfully!</h5>
                        <p className="text-xs text-emerald-100">Connecting you to WhatsApp Specialists...</p>
                      </div>
                    ) : (
                      <form onSubmit={handleAdviceSubmit} className="space-y-3.5">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                          ...
                          <div className="space-y-1 text-left">
                            ...
                            <div className="country-dropdown-container relative flex bg-white/10 rounded-xl border border-white/25 focus-within:border-white focus-within:bg-white group transition-all">
                              ...
                              {isCountryDropdownOpen && (
                                <div className="absolute left-0 top-full mt-2 w-64 max-h-60 bg-white border border-slate-200 rounded-xl shadow-2xl z-50 flex flex-col overflow-hidden text-slate-800 animate-fade-in">
                                      ...
                                      filteredCountries.map((c) => (
                                        ...
                                        >
                                          <span className="flex items-center gap-1.5">
                                            ...
                                            <span className="font-semibold text-slate-700 truncate max-w-[130px]">{c.name}</span>
                                          </span>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-1">
                          <p className="text-[10.5px] text-emerald-100/90 font-bold italic text-left">
                            1 Instant to buy and import this product? We're here to guide you!
                          </p>
                          <button 
                            type="submit"
                ...
                <div className="space-y-4 pt-4" id="sec-advantage">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm text-justify">
                    Several reputable companies are actively engaged in the sale and export of Iranian kiwi to Russia. Sabz Gostaran Gilan Fruit (GilaFruit), specializing in this sector, offers the following advantages to its Russian customers, making buying kiwi for import to Russia an easy and reliable experience:
                  </p>

                  <ol className="space-y-4 text-xs sm:text-sm text-slate-650 pl-4 list-decimal font-semibold">
                    <li>
                      <span className="text-slate-900 font-black">Guaranteed Supply from Origin:</span> Our focus is on direct sourcing from high-quality farms in the Gilan and Mazandaran provinces (especially Talesh and Astara) to ensure the best Super-Luxe Iranian Kiwi is prepared without intermediaries and under strict quality control.
                    </li>
                    <li>
                      <span className="text-slate-900 font-black">Cold Storage and Preparation Capacity:</span> We possess the necessary cold storage capacity for the preservation and calibration of volumes of bulk purchased Iranian kiwi. This assures importers that the kiwi will be handled under ideal conditions according to the agreed shipping schedule.
                    </li>
                    <li>
                      <span className="text-slate-900 font-black">Specialized Logistics Support:</span> Our team not only supplies the kiwi but also provides comprehensive support in coordinating standard refrigerated trailers for land transport or equipped containers for sea freight to Russian ports.
                    </li>
                  </ol>
                </div>
                ...
                <div className="space-y-2">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                    <img 
                      ...
                      alt="GilaFruit cold storage capacity"
                      className="w-full h-64 object-cover"
                    />
                    <div className="absolute bottom-0 inset-x-0 bg-black/60 backdrop-blur-sm p-2 text-white flex justify-between text-[11px] font-mono font-bold">
                      <span>www.GilaFruit.com</span>
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    GilaFruit cold storage capacity for pre-export holding of Kiwi to Russia
                  </p>
                </div>

                <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-xl">
                  <p className="text-[11.5px] font-bold text-amber-900 uppercase tracking-wider mb-1">Pricing Transparency Note</p>
                  <p className="text-xs text-amber-800 leading-relaxed font-semibold">
                    The export price of kiwi to Russia depends on various factors, including packaging type, quality level, size level, and availability period. We strive to guarantee importer profitability by offering transparent and competitive daily prices for exported kiwi to Russia.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                    <img 
                      ...
                      alt="Bulk Purchase of Iranian Kiwi with GilaFruit brand"
                      className="w-full h-64 object-cover"
                    />
                    <div className="absolute bottom-0 inset-x-0 bg-black/60 backdrop-blur-sm p-2 text-white flex justify-between text-[11px] font-mono font-bold">
                      <span>www.GilaFruit.com</span>
                  ...
                  <p className="text-[11px] text-slate-500 font-bold text-center">
                    Bulk Purchase of Iranian Kiwi with GilaFruit brand, showing competitive Export Price of Kiwi to Russia
                  </p>
                </div>
                ...
                <div className="border-t border-slate-200 pt-8 space-y-4">
                  <h3 className="font-display text-md sm:text-lg font-black text-slate-900 uppercase tracking-tight flex items-center gap-1.5">
                    ...
                    Frequently Asked Questions about Kiwi Import
                  </h3>
                  <div className="space-y-2.5">
                    {[
                      {
                        q: 'What is the average Export Price of Kiwi to Russia?',
                        a: 'The export price of kiwi to Russia fluctuates daily and depends heavily on the quality grade (Super Luxe vs. Standard), current sorting caliber, box weight options, and seasonal availability. GilaFruit guarantees the highest direct-from-farm pricing parity.'
                      },
                      {
                        q: 'What are the main shipping routes and transit times for Kiwi import to Russia?',
                        a: 'Transit is typically handled via land transport (using refrigerated trucks through Astara/Bilehsavar borders, passing Azerbaijan into Dagestan) taking 7-10 days, or sea freight (Caspian Sea vessels unloading at Astrakhan port) taking 10-14 days.'
                      },
                      {
                        q: 'Which kiwi quality standards are mandatory for Russian Customs?',
                        a: 'The mandatory documentation includes the original Phytosanitary Health & Quarantine Permit issued by the Plant Protection Organization, an international SGS quality certificate, standard food safety compliance certificates, and customs invoices stating HS Code 08105000.'
                      },
                      {
                        q: 'When is the best time to Buy Kiwi for Import to Russia?',
                        a: 'Iranian kiwi harvest kicks off in late September, with bulk supply streams fully operational from October until May. We recommend sealing contracts in October-November to unlock optimal price matrices and peak brix scores.'
                      }
                    ].map((faq, i) => (
            ...
            <div className="mt-10 pt-6 border-t border-slate-200 flex flex-wrap justify-between items-center gap-4 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2">
                <span className="text-slate-400 font-bold">Share this post:</span>
            ...
            <div className="mt-16 pt-10 border-t border-slate-200 space-y-8">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-slate-400 font-semibold italic">Offline-moderated storage</span>
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-5 sm:p-6 shadow-xs text-left space-y-4">
                <div className="space-y-1 border-b border-slate-100 pb-2">
                  ...
                  <p className="text-[11px] text-slate-400 font-bold">
                    Your email address will not be published. Required fields are marked <span className="text-red-500 font-extrabold">*</span>
                  </p>
                </div>
                ...
                <form onSubmit={handleCommentSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea 
                      ...
                      rows={4}
                      required
                      placeholder="Share your thoughts or questions about importing fruits from Iran..."
